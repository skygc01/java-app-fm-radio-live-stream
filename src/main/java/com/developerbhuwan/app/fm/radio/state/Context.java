 ...
 *
 */
package com.developerbhuwan.app.fm.radio.state;
...
public class Context {
    ...
    private FmPlayer currentFmPlayer;

    public FmPlayer getCurrentFmPlayer() {
        return currentFmPlayer;
    }

    public void setCurrentFmPlayer(FmPlayer currentFmPlayer) {
        this.currentFmPlayer = currentFmPlayer;
    }
